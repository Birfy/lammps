...
#ifdef FIX_CLASS
// clang-format off
FixStyle(bond/move,FixBondMove);
// clang-format on
#else

#ifndef LMP_FIX_BONDMOVE_H
#define LMP_FIX_BONDMOVE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixBondMove : public Fix {
 public:
  FixBondMove(class LAMMPS *, int, char **);
  ~FixBondMove() override;
